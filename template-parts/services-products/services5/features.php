...
$all_query=  new WP_Query(
  array(
      'post_type'=>'post',
      'post_status'=>'publish',
      'category_name'=>'services5-feature'
     )
    );
         ...
         <?php  if( class_exists('Dynamic_Featured_Image') ) {
                  ...
                  $featured_images = $dynamic_featured_image->get_featured_images( );
                    ...
                    foreach($featured_images as $key=> $featured_image) {
                      ...
                      echo '<div class="services6-image"><img src="'.$featured_image["full"].'"></div>';
           ...
           <section class="services6-content-features">
             <div class="services6-content-features-box">
               <div class="services6-content-features-box-t"><?php the_title();?></div>
